...
class AppColors {
  static Color primaryColor = const Color.fromRGBO(61, 61, 110, 1);
  static Color secondaryColor = Colors.white;
  static Color appColor = Colors.deepPurpleAccent.shade400;
  static Color iconColor = Colors.white;
  static Color titleTextColor = const Color.fromRGBO(55, 53, 89, 1);
