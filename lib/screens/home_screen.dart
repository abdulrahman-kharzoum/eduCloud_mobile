        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            GestureDetector(
                ...
                child:
                    advertisementesContainerWidget(screenHight: screenHight)),
            SizedBox(
              height: screenHight / 10,
            ),
            //this container for first tow topic
            Container(
              margin: EdgeInsets.symmetric(horizontal: screenWidth / 70),
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () =>
                        GoRouter.of(context).push(AppRouter.installmentsScreen),
                    child: topicWidget(
                      screenHight: screenHight,
                      screenWidth: screenWidth,
